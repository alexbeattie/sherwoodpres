...
//  sherwoodrealestate
//
//  Created by Alex Beattie on 6/29/18.
//  Copyright © 2018 Alex Beattie. All rights reserved.
//

import UIKit
import Parse
class ClubsSlides: BaseCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    var listings: [Listing.listingResults]!
//    var newListings: Parse
//    var image = PFObject
    var images:[String] = []
    //    var images:String?
