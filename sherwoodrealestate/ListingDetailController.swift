...
//                    mail.addAttachmentData(UIImageJPEGRepresentation(UIImage(named: "emailImage")!, CGFloat(1.0))!, mimeType: "image/jpeg", fileName:  "test.jpeg")
            ...
            mail.setSubject("[iPhone App Contact] Interested in \(String(describing: listing!.StandardFields.UnparsedFirstLineAddress))")
...
//        barBtn.tintColor = UIColor.black
        ...
        toolbar.items = [add, flexible, compose, flexible, search]
